...
INSERT INTO products (title,price,description,category,image) VALUES
		...
		('Smartphone', 799.99, 'Um smartphone de última geração com câmera de alta resolução e desempenho rápido.', 'Eletrônicos', ''),
		('Notebook', 1299.99, 'Um notebook potente com processador de última geração e tela de alta definição.', 'Eletrônicos', ''),
		('Fone de Ouvido Bluetooth', 99.99, 'Fone de ouvido sem fio com cancelamento de ruído e bateria de longa duração.', 'Eletrônicos', ''),
		('Smart TV', 899.99, 'Uma Smart TV com resolução 4K e acesso a vários aplicativos de streaming.', 'Eletrônicos', ''),
		('Tablet', 299.99, 'Um tablet leve e portátil, perfeito para navegar na internet e consumir conteúdo multimídia.', 'Eletrônicos', ''),
		('Tênis de Corrida', 129.99, 'Tênis de corrida com tecnologia de amortecimento avançada para máximo conforto durante a prática esportiva.', 'Esportes', ''),
		('Bola de Futebol', 39.99, 'Bola de futebol profissional feita de material resistente para durabilidade e precisão.', 'Esportes', ''),
		('Raquete de Tênis', 79.99, 'Raquete de tênis de alta qualidade com empunhadura ergonômica e excelente controle.', 'Esportes', ''),
		('Bicicleta Mountain Bike', 599.99, 'Bicicleta mountain bike com suspensão dianteira e câmbio de marchas para enfrentar trilhas desafiadoras.', 'Esportes', ''),
		('Bola de Basquete', 29.99, 'Bola de basquete oficial com design profissional e material durável.', 'Esportes', '');
